        ...
        <div>
            ...
            <div class="container1">
                <div class="organization-card">
                    ...
                    <Link to="/Org1amount" class="Donatebutton">More</Link>
                </div>
                <div class="organization-card">
                    ...
                    <Link to="/Org2amount" class="Donatebutton">More</Link>
                </div>
                ...
                <div class="organization-card">
                    ...
                    <Link to="/Org3amount" class="Donatebutton">More</Link>
                </div>
            </div>
        </div>
    );
